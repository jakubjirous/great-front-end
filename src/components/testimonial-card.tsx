...
export default function TestimonialCard({
	...
	return (
		<blockquote
			...
			className="w-[21.25rem] flex flex-col gap-4 bg-white p-6 rounded-lg shadow-testimonial-card"
		>
			<div className="grid grid-cols-[3rem,1fr] items-center gap-4 self-stretch">
				...
				<div className="flex flex-col gap-px flex-grow w-full truncate">
					<h1
						...
						className="font-semibold text-lg text-justify text-neutral-900 truncate"
					>
						{title}
					</h1>
